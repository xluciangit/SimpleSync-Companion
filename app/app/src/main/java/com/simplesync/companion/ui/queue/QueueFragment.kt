...
class JobAdapter(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        val style = when (job.status) {
            ...
            JobStatus.COMPLETED -> StatusStyle("Done",      0xFF16A34A.toInt(), 0xFFDCFCE7.toInt())
        ...
        // Show progress bar + % + speed while uploading
        val isUploading = job.status == JobStatus.UPLOADING
        b.uploadProgressRow.isVisible = isUploading
        if (isUploading) {
